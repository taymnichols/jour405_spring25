...
Based on this it doesn't really seem like there is one. A few schools have 100 percent of student on FARMS with varying degrees of student math success (57 to 78 percent ish?). For schools not on that line, it seems like schools with fewer FARMS students have varying degrees of math success, but past 25 percent threshold it looks like more students on FARMS = higher math scores.
...
A) Based on this information it seems like our data doesn't really line up very well with our model results. It looks like based on the adjusted r squared value, just 2.5 percent of our schools' math scores can be explained by their number of FARMS students. Our p-value is also high. So far i have not been convinced this makes sense to use. 
...
Whitemarsh, Gulph, Crooked Billet and Lower Gwynedd are the schools with the widest variation between the predicted and actual scores, all by at least 30 percentage points.
...
From this model I would conclude that there doesn't seem to be a strong relationship between FARMS students and math test performance. While family income may influence how well kids do on math tests, there seem to be a lot of other factors at play. I would probably pitch that data doesn't back up this statement, and I would explore other factors at schools that did well or poorly compared to their predictions by the model that may be influencing student math test scores.
