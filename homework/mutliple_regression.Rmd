...
Looks like unemployment rates and race are most closely correlated with voter turnout. Percent white and population are also fairly correlated with each other, although I am not sure that this really makes sense? Education level and income are correlated as well.


Looking at the scatterplots, it looks like unemployment rate, percent white and percent bachelor's or higher have the most linear relationships. Population, income and median age don't seem like the ydo.
...
The residuals seem pretty spot on -- the min is -.05 and hte max is .024 so they are really close to the actual datapoints. Looking at the coefficients, it looks like pop, pct_bachelors and pct_unemployment are all not statistically significant. Income, median age and percent white are all statistically significant -- income seems to have a small positive correlation (higher income = more turnout), as does median age (older = more turnout). Pct white seems to have the highest positive correlation/is most correlated (more white = more turnout). 

Pop, pct bachelors or higher and pct unemployed all have a negative correlation.

The Multiple R-squared tells us 85 percent of the variability can be explained by the model. Adjusted R-Squared tells us 80 pct of the data in our model can be explained by these relationships.The overall p-value of the model is statistically significant. Overall, I would say this is a pretty good fit! Statistically significant and explains a lot of the data!
...
Looks like Model 4 is slightly better than the others, Model 3 bombed, and Model 2 was the same as our initial model.
...
I would use this to talk about who is most likely to turnout and use it to look at get out the vote efforts, who politicians are targeting/who their base is, and how voter turnout differed from the "norm," maybe in early voter data.
